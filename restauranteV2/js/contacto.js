// Tailwind configuration extracted from contacto.html
tailwind.config = {
  darkMode: "class",
  theme: {
    extend: {
      colors: {
        ...
        "text-light-primary": "#1b130d",
        "text-light-secondary": "#9a6c4c",
        "text-dark-primary": "#fcfaf8",
        "text-dark-secondary": "#9a8a7c",
        "border-light": "#e7d9cf",
        "border-dark": "#3a2a1a",
      },
      fontFamily: {
